...
time_2 = ds.datetime.strptime('01:01:10',"%H:%M:%S") #還沒測試毫秒

time_interval = time_2 - time_1
print("兩時間差")
print(time_interval)
print(time_interval.seconds)
print(time_interval.microseconds)


print("=============================================")
""" time_interval.seconds = 61 #XXX
print(time_interval)
print(time_interval.seconds) """
...
#     lines_str = len(f.readlines()) 
#     print(str(lines_str) +" 行 -------")
#     f.close()
# =============================================================================
...
try:   
    ...
    RealStrList1_TL.append(RealStrList1[len(RealStrList1)-1] + ",000 --> " + "99:99:99,999")
